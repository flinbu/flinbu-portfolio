<template>
    <b-container id="contact" class="module module__contact content content__middle py-8 py-lg-10">
        <b-col class="module__wrapper">
            <b-row class="module__content" align-v="center" align-h="center">
                <b-col class="module__data order-2 order-lg-1" cols="12" md="6">
